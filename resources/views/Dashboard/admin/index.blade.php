...
<div class="row">
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card"  style="box-shadow: 10px 5px 5px black;">
            <div class="card-body">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card"  style="box-shadow: 10px 5px 5px rgb(145, 145, 35);">
            <div class="card-body">
                <h5 class="text-muted">Chiffre d'affaire / mois</h5>
                <div class="metric-value d-inline-block">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card"  style="box-shadow: 10px 5px 5px rgb(202, 168, 57);">
            <div class="card-body">
                <h5 class="text-muted">Total des produits</h5>
                <div class="metric-value d-inline-block">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card" style="box-shadow: 10px 5px 5px rgb(37, 151, 204);">
            <div class="card-body">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card" style="box-shadow: 10px 5px 5px black;">
            <div class="card-body">
                <h5 class="text-muted">Commande</h5>
                <div class="metric-value d-inline-block">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card"  style="box-shadow: 10px 5px 5px green;">
            <div class="card-body">
                <h5 class="text-muted">Commande valide / mois</h5>
                <div class="metric-value d-inline-block">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card"  style="box-shadow: 10px 5px 5px red;">
            <div class="card-body">
                <h5 class="text-muted">Commande Invalide / mois</h5>
                <div class="metric-value d-inline-block">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card" style="box-shadow: 10px 5px 5px rgb(37, 151, 204);">
            <div class="card-body">
                <h5 class="text-muted">Total des client</h5>
                <div class="metric-value d-inline-block">
