...
<body>
    <div style="display: flex; flex-direction: column; justify-content: center;">
        <div class="row" style="display: flex; flex-direction: row; justify-content: space-between; width:100%;"> 
            <div class="column">
                <img src="{{ asset("Company_logo/".$entrepris[0]['logo']) }}" width="200px" height="">&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        ...
        <div style="text-align:center;background-color:#ddd; width:100%;border:1px solid #000;padding:5px;margin-top: 40px">
    ...
    <div style="width: 100%;position:absolute; bottom:5%;height: 60px;" >
        <hr style="width: 100%; color: #eee;padding-right:40px">
        <div style="display:flex;align-items: center">
            <div style="float:left;width:180px;text-align: center;height: 100%; font-size: 20px" >
                <strong>Livreur</strong> 
                <strong>Nom:<span>..................</span></strong> 
            </div>
            <div style="float: right;width:800px;text-align: center;padding-right:60px;height: 100%; font-size: 20px">
                {{ $entrepris[0]['addresse_entrepri'] }} -RC: {{ $entrepris[0]['RC'] }} - IF: {{ $entrepris[0]['IF'] }} - TP: {{ $entrepris[0]['TP'] }} <br>ICE : {{ $entrepris[0]['ICE'] }} Tél :{{ $entrepris[0]['phone_entrepri'] }}/GSM :{{ $entrepris[0]['GSM_entrepri'] }}
