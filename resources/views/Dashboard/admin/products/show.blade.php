            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="mb-0"></h5>
                        <a href="{{ route('products.create') }}" class=" text-success">Ajouter un produit <i class=" fas fa-plus-circle"></i></a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td class="text-center">@if ($product->QNT > 0)
                                                    <span class="badge badge-success">Disponible</span> 
                                                @else
                                                    <span class="badge badge-danger">indisponible</span> 
                                                @endif
                                            </td>
                                            <td class="text-center"><img src="{{ asset('product_image/'. $product->image ) }}" width="50px" alt=""></td>
                                            <td class="text-center">{{ $product->depot->name }}</td>
                                            <td class="text-center">{{ $product->categorie->name }}</td>
                                            <td style="width:10%;">
                                                <div class="d-flex justify-content-between">
                                                        <a href="{{ route('products.edit',$product->id) }}" class="btn btn-primary rounded">Editer</a>
                                                        <a href="#"
