                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="ref" readonly id="validationCustom03" placeholder="Référence" value="{{ old("refe") }}" >
                                </div>
                                <div class="col-md-6">
                                    <label for="validationCustom04" class="mt-3">Nom de produit <span style="color:red;">*</span></label>
                                    <input type="text" class="form-control" name="name" id="validationCustom04" placeholder="Nom de produit" value="{{ old("name") }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="validationCustom03" class="mt-3">Prix <span style="color:red;">*</span></label>
                                    <input type="text" name="price" class="form-control" id="validationCustom03" value="{{ old("price") }}" placeholder="prix" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="validationCustom03" class="mt-3">Quantité <span style="color:red;">*</span></label>
                                    <input type="text" name="QNT" class="form-control" id="validationCustom03" value="{{ old("QNT") }}" placeholder="Quantité" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="validationCustom03" class="mt-3">Percentage % :</label>
                                    <input type="text" name="percentage" class="form-control" id="validationCustom03" value="{{ old("percentage") }}" placeholder="Percentage" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="" class="mt-3">Choisir la catégorie <span style="color:red;">*</span></label>
                                    <div class="d-flex ">
                                ...
                                <div class="col-md-6">
                                    <label for="" class="mt-3">Choisir Le dépot <span style="color:red;">*</span></label>
                                    <div class="d-flex ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        <input type="hidden" name="_token" id="csrf" value="{{Session::token()}}">
                        <label for="validationCustom03">Nom :</label>
                        <input type="text" name="depot" id="name_depot" class="form-control" placeholder="Nom" required>
