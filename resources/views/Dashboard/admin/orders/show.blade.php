            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="mb-0"></h5>
                        <a href="{{ route('orders.create') }}" class=" text-success">Ajouter une Commande <i class=" fas fa-plus-circle"></i></a>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="" method="GET">
                        ...
                        <button type="submit" onclick="event.preventDefault(); this.closest('form').submit();" class="btn btn-danger rounded">Télécharger PDF</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(".table" ).on('click','.btn_details',function(e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response.DetailsOrder, function (key,item) { 
                         $('#Data_Order').append("<tr><td>"+item.product_name+"</td><td><input type='hidden' class='input_id_detailOrder_router' data-input_id_detailOrder_router='"+item.id+"'/><input type='number' class='input_QNT_router' style='width:60px;' value='"+item.QNT+"'/></td><td>"+item.price+" DH</td><td>"+item.percentage+" %</td><td>"+item.profit+" DH</td><td>"+item.total+" DH</td></tr>");
            ...
            $(".table" ).on('change','.input_QNT_router',function(e) {
                ...
                var input_id_detailOrder_router = input_id_detailOrder_router_val.getAttribute('data-input_id_detailOrder_router');

                $.ajax({
                    type: "GET",
                    url: "{{ route('order.router') }}",
                    data: {input_QNT_router:input_QNT_router,input_id_detailOrder_router:input_id_detailOrder_router},
                    success: function (response) {
