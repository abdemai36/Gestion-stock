...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <form class="row" action="{{ route('invoice.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-sm-3 col-md-6 col-lg-6  ">
                        ...
                        <div class="p-4 card ">
                            ...
                            <div class="d-flex" >
                                <a href="#" data-toggle="modal" id="add_depotOrder"
                                data-target="#model_depot" class="btn btn-success"><i class=" fas fa-plus-circle"></i></a>
                        ...
                        <div class="card p-4">
                            ...
                            <button type="submit" name="Send_invoice" value="Send_invoice" class="btn btn-primary mt-3">Envoyer</button>
                        </div>
                    </div>
                </form>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        <input type="hidden" name="_token" id="csrf" value="{{Session::token()}}">
                        <label for="validationCustom03">Nom :</label>
                        <input type="text" name="depot" id="name_depot_order" class="form-control" placeholder="Nom" required>
                        <label for="validationCustom03" class="mt-3">Adresse :</label>
                        <input type="text" name="addresse" id="addresse_order" class="form-control" placeholder="adresse" >
